...
{ "ER_CHECKREAD", 1020, "Record has changed since last read in table \'%-.192s\'; try restarting transaction" },
...
{ "ER_SERVER_IS_IN_SECURE_AUTH_MODE", 1275, "User \'%s\'@\'%s\' has a password in the old format; please change the password to the new format" },
...
{ "ER_CANT_CREATE_USER_WITH_GRANT", 1410, "You are not allowed to create a user with %s" },
...
{ "ER_MALFORMED_DEFINER", 1446, "The user specified as a definer (\'%-.64s\'@\'%-.64s\') does not exist" },
...
{ "ER_NO_SUCH_USER", 1449, "The user \'%-.64s\'@\'%-.64s\' does not exist" },
...
{ "ER_CANT_SET_IN_TRANSACTION", 1568, "%s can\'t be set while a transaction is in progress" },
...
{ "WARN_OPTION_IGNORED", 1618, "%s option ignored" },
...
{ "ER_VARIABLE_NOT_SETTABLE_IN_SF_OR_TRG", 1765, "The system variable %.200s cannot be set in stored functions or triggers" },
...
{ "ER_ACCESS_DENIED_CHANGE_USER_ERROR", 1873, "Access denied trying to change to user \'%-.48s\'@\'%-.64s\'" },
...
{ "ER_STATEMENT_TIMEOUT", 1969, "Query was interrupted: execution time limit %s exceeded" },
...
{ "WARN_INNODB_PARTITION_OPTION_IGNORED", 1982, "%s option ignored for InnoDB partition" },
...
{ "ER_UNKNOWN_DATA_TYPE", 4161, "Unknown data type: \'%-.384s\'" },
...
{ "ER_TEMPORARY_TABLES_PREVENT_SWITCH_GTID_DOMAIN_ID", 4209, "Cannot modify @@session.gtid_domain_id while there are open temporary tables being binlogged" },
{ "ER_TOO_MANY_OPEN_CURSORS", 4210, "Too many open cursors; max %u cursors allowed" },
{ "ER_INCOMPATIBLE_EVENT_FLAG", 4211, "Event flag \'%s\' in the condition expression is not compatible with the trigger event type \'%s\'" },
{ "ER_NOT_IMPLEMENTED_FOR_GEOGRAPHIC_SRS", 4212, "%s has not been implemented for geographic spatial reference systems." },
{ "ER_LONGITUDE_OUT_OF_RANGE", 4213, "Longitude %f is out of range in function %s. It must be within (-180.000000, 180.000000]." },
{ "ER_LATITUDE_OUT_OF_RANGE", 4214, "Latitude %f is out of range in function %s. It must be within [-90.000000, 90.000000]." },
{ "ER_GIS_DIFFERENT_SRIDS_AGGREGATION", 4215, "Arguments to function %s contains geometries with different SRIDs: %d and %d. All geometries must have the same SRID." },
{ "ER_SEQUENCE_TABLE_HAS_TOO_FEW_ROWS", 4216, "Fewer than one row in the table" },
{ "ER_SEQUENCE_TABLE_HAS_TOO_MANY_ROWS", 4217, "More than one row in the table" },
{ "ER_WARN_OPTIMIZER_HINT_SYNTAX_ERROR", 4218, "Optimizer hint syntax error" },
{ "ER_WARN_CONFLICTING_HINT", 4219, "Hint %s is ignored as conflicting/duplicated" },
{ "ER_WARN_UNKNOWN_QB_NAME", 4220, "Query block name %s is not found for %s hint" },
{ "ER_UNRESOLVED_TABLE_HINT_NAME", 4221, "Unresolved table name %s for %s hint" },
{ "ER_UNRESOLVED_INDEX_HINT_NAME", 4222, "Unresolved index name %s for %s hint" },
{ "ER_HINTS_INSIDE_VIEWS_NOT_SUPPORTED", 4223, "Optimizer hints are not supported inside view definitions" },
{ "ER_WARN_MALFORMED_HINT", 4224, "Hint %s is ignored as malformed" },
{ "ER_WARN_HINTS_ON_INSERT_PART_OF_INSERT_SELECT", 4225, "Optimizer hints at the INSERT part of a INSERT..SELECT statement are not supported" },
{ "ER_INIT_SLAVE_ERROR", 4226, "Slave SQL thread aborted. Can\'t execute init_slave query due to error code %u: %s" },
{ "ER_ACTIVE_CONNECTIONS_FOR_USER_TO_DROP", 4227, "Dropped users %s have active connections. Use KILL CONNECTION if they should not be used anymore." },
{ "ER_ASSOC_ARRAY_ELEM_NOT_FOUND", 4228, "Element not found with key \'%s\'" },
{ "ER_NULL_FOR_ASSOC_ARRAY_INDEX", 4229, "NULL key used for associative array \'%s\'" },
{ "ER_NEED_NAMED_ASSOCIATION", 4230, "Initializing %s requires named association" },
{ "ER_INVALID_USE_OF_ORA_JOIN", 4231, "Invalid usage of (+) operator" },
{ "ER_INVALID_USE_OF_ORA_JOIN_CYCLE", 4232, "Invalid usage of (+) operator: cycle dependencies" },
{ "ER_INVALID_USE_OF_ORA_JOIN_OUTER_REF", 4233, "Invalid usage of (+) operator with outer reference %s" },
{ "ER_INVALID_USE_OF_ORA_JOIN_ONE_TABLE", 4234, "Invalid usage of (+) operator: both tables %s and %s are of %s type in the relation" },
{ "ER_INVALID_USE_OF_ORA_JOIN_WRONG_FUNC", 4235, "Invalid usage of (+) operator: used in OR, IN or ROW operation" },
{ "ER_INVALID_USE_OF_ORA_JOIN_MIX", 4236, "Invalid usage of (+) operator: mixed with other type of join" },
{ "WARN_ORA_JOIN_IGNORED", 4237, "Oracle outer join operator (+) ignored in \'%-.100s\'" },
{ "ER_WARN_CONFLICTING_INDEX_HINT_FOR_TABLE", 4238, "Hint %s is ignored as conflicting/duplicated (an index hint of the same type has already been specified for this table)" },
...
{ "ER_BINLOG_IN_USE", 4243, "Cannot execute RESET MASTER as the binlog is in use by a connected slave or other RESET MASTER or binlog reader. Check SHOW PROCESSLIST for \"Binlog Dump\" commands and use KILL to stop such readers" },
{ "ER_BINLOG_IN_USE_TRX", 4244, "Cannot execute RESET MASTER as the binlog is in use by an active transaction" },
{ "ER_CANNOT_INIT_ENGINE_BINLOG_READER", 4245, "Cannot initialize binlog reader from storage engine %s" },
{ "ER_ENGINE_BINLOG_REQUIRES_GTID", 4246, "GTID starting position is required on master with --binlog-storage-engine enabled" },
{ "ER_NOT_AVAILABLE_WITH_ENGINE_BINLOG", 4247, "%s is not available when --binlog-storage-engine is enabled" },
{ "ER_NOT_YET_SUPPORTED_ENGINE_BINLOG", 4248, "%s is not yet supported with --binlog-storage-engine" },
{ "ER_ENGINE_BINLOG_NO_DELETE_DOMAIN", 4249, "The binlog engine does not support DELETE_DOMAIN_ID" },
{ "ER_BINLOG_CANNOT_READ_STATE", 4250, "Error reading GTID state from the binlog" },
{ "ER_BINLOG_POS_INVALID", 4251, "The binlog offset %llu is invalid" },
{ "ER_READING_BINLOG_FILE", 4252, "Error reading from page number %u in binlog file (error code: %d)" },
{ "ER_PARTIAL_ROWS_LOG_EVENT_BAD_STREAM", 4253, "Broken Partial_rows_log_event stream. Found %s, expected %s" },
{ "ER_SLAVE_INCOMPATIBLE_TABLE_DEF", 4254, "Table structure for binlog event is not compatible with the table definition on this slave: %s" },
{ "ER_UNSUPPORTED_DATA_TYPE_ATTRIBUTE", 4255, "Data type \'%-.64s\' doesn\'t support %s attribute." },
{ "ER_CANT_CREATE_TMP_ALTER_TABLE", 4256, "Can\'t create temporary table for ALTER TABLE %sQ.%sQ (errno: %iE)" },
{ "ER_CANNOT_CAST_ON_IDENT1_ASSIGNMENT_FOR_OPERATION", 4257, "Cannot cast \'%s\' as \'%s\' in assignment of %sQ for operation %s" },
{ "ER_CANNOT_CAST_ON_IDENT2_ASSIGNMENT_FOR_OPERATION", 4258, "Cannot cast \'%s\' as \'%s\' in assignment of %sQ.%sQ for operation %s" },
{ "ER_WARN_AMBIGUOUS_QB_NAME", 4259, "Query block name %s is ambiguous for %s hint" },
{ "ER_WARN_IMPLICIT_QB_NAME_FOR_UNION", 4260, "Implicit query block name %s is not supported for derived tables and views with UNION/EXCEPT/INTERSECT and is ignored for %s hint" },
{ "ER_WARN_QB_NAME_PATH_INVALID_SELECT", 4261, "Hint %s is ignored. Element #%u of the path contains invalid select number (expected: @SEL_1, @SEL_2, ...)." },
{ "ER_WARN_QB_NAME_PATH_SELECT_NOT_FOUND", 4262, "Hint %s is ignored. SEL_%u required at element #%u of the path is not found in the target query block." },
{ "ER_WARN_QB_NAME_PATH_VIEW_NOT_FOUND", 4263, "Hint %s is ignored. `%s` required at element #%u of the path is not found in the target query block." },
{ "ER_WARN_QB_NAME_PATH_NOT_SUPPORTED_INSIDE_VIEW", 4264, "Hint %s is ignored. QB_NAME hints with path are not supported inside view definitions." },
{ "ER_PARTITION_INTERVAL_NOT_LIST", 4265, "LIST partition type does not support INTERVAL" },
{ "ER_PARTITION_INTERVAL_FINER_THAN_DATE", 4266, "RANGE COLUMN partition by a DATE with INTERVAL smaller than date" },
{ "ER_PARTITION_INTERVAL_MAXVALUE", 4267, "MAXVALUE is not allowed in range partitioning with interval" },
{ "ER_RANGE_INTERVAL_PART_FAILED", 4268, "Range partition table %`s.%`s: adding INTERVAL partition(s) failed" },
{ "ER_JSON_OPTIMIZER_REPLAY_CONTEXT_PARSE_FAILED", 4269, "Failed to parse saved optimizer context: %s at offset %d." },
{ "ER_JSON_OPTIMIZER_REPLAY_CONTEXT_MATCH_FAILED", 4270, "Failed to match the stats from replay context with the optimizer stats: %s doesn\'t exist in %s" },
